...
st.sidebar.header("Your Produt Wizard")

# Allow the user to specify the number of similar images to retrieve
num_similar_images = st.sidebar.slider("Add Search Parameters for your liking - How many similar images you would like:", 1, 15, 3)

# Allow the user to upload an image
uploaded_image = st.file_uploader("Upload your image (jpg, png, jpeg)", type=["jpg", "png", "jpeg"])
...
if uploaded_image is not None:
    ...
    st.title("Checkout the similar product!")

    # Execute the query when the user clicks the button
    if st.button("Query It!"):
        st.write("The result is coming up soon...")
        ...
        st.write("Images similar to your input:")
